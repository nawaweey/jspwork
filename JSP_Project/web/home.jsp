...
<body class="bg-light">
	...
	<main role="main" class="container">
		...
		<div style="background-color: #065fb3;text-align:center;padding:30px;margin-top:7px;color: white; height: 85px;">
			 <marquee >ยินดีต้อนรับสู่ Java Server Page FINAL 2019!!!!!!    |   ยินดีต้อนรับสู่ Java Server Page FINAL 2019!!!!!! |   ยินดีต้อนรับสู่ Java Server Page FINAL 2019!!!!!!</marquee> 

	</main >
	<p  class="mt-5 small text-muted text-center">&copy; 2019 DarkSky</p>
