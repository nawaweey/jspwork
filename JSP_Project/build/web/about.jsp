...
<body class="bg-light">
	...
	<main role="main" class="container">
		<h2 class="tt"><i class="fas fa-id-card"></i>&nbsp; ผู้จัดทำ</h2>
		<div class="card">
			<div class="card-body">
				<div class="row text-center pt-4">
					<div class="col-lg-4 pb-4">
						<img alt="ธีรณัฐ มหัทธโนบล" class="rounded-circle shadow" width="140" height="140" src="assets/img/nawawee.jpg" />
						<h5 class="pt-4 mb-3">ผู้พัฒนาระบบ</h5>
						<h2>นาวาวี ยะยอ</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010015</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/profile.php?id=100007561119699" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @Nawawee Yahyo</a></p>
					</div>
					<div class="col-lg-4 pb-4">
						<img alt="อาสูรา สาเมาะ" class="rounded-circle shadow" width="140" height="140" src="assets/img/th.jpg" />
						<h5 class="pt-4 mb-3">ผู้ช่วยพัฒนาระบบ</h5>
						<h2>ธนากร หะยีเจะมะ</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010016</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/arfan.hayeecakma" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @Tanakorn Hayeechema</a></p>
					</div>
					<div class="col-lg-4 pb-4">
						<img alt="ธีระ บินกาเซ็ม" class="rounded-circle shadow" width="140" height="140" src="assets/img/ti.jpg" />
	...
	<p class="mt-4 small text-muted text-center">&copy; 2019 DarkSky</p>
